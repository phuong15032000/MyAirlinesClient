...
public class addAirplane extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet addAirplane</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet addAirplane at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            airbrandList = (List<Airbrand>) object2;
            
            request.setAttribute("aircraftList", aircraftList);
            request.setAttribute("airbrandList", airbrandList);
            request.getRequestDispatcher("addAirplane.jsp").forward(request, response);
