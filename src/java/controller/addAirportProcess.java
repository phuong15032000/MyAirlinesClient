...
import static controller.ClientFTP.din;
import static controller.ClientFTP.dout;
...
public class addAirportProcess extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ClientFTP.dout.writeUTF("addAirport");
...
//        ClientFTP.dout.writeUTF(airportName);
        ...
        if (ClientFTP.din.readUTF().equals("addAirportSuc")) {
