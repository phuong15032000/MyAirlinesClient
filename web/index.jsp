<%-- 
    Document   : adminPage
    Created on : Oct 10, 2020, 1:46:02 PM
    Author     : DELL
--%>
...
<html>
    ...
    <body>
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item " href="<c:url value="/addAirplane"/>">Thêm Máy Bay</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header"><span>Quản lí nhân sự</span>:</h6>
                            <a class="collapse-item" href="<c:url value="/admin/addAdmin"/>">Thêm người quản lý</a>
                            <a class="collapse-item" href="<c:url value="/admin/allAdmin"/>">Liệt kê quản lý
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <c:choose>
                                    <c:when test="${empty sessionScope.username}">
                                        <a class="nav-link dropdown-toggle" href="<c:url value="/login"/>" id="userDropdown" role="button" aria-haspopup="true" aria-expanded="false">
        ...
        <script src="/resources/adminPage/jquery/jquery.min.js"></script>
        <script src="/resources/adminPage/bootstrap/js/bootstrap.bundle.min.js"></script>

        <!-- Core plugin JavaScript-->
        <script src="/resources/adminPage/jquery-easing/jquery.easing.min.js"></script>

        <!-- Custom scripts for all pages-->
        <script src="/resources/adminPage/sb-admin-2.min.js"></script>

        <!-- Page level plugins -->
        <script src="/resources/adminPage/chart.js/Chart.min.js"></script>

        <!-- Page level custom scripts -->
        <script src="/resources/adminPage/demo/chart-area-demo.js"></script>
        <script src="/resources/adminPage/demo/chart-pie-demo.js"></script>
        ...
        <script src="<c:url value="/resources/adminPage/chart.js/Chart.min.js"/>"></script>
        <script src="<c:url value="/resources/adminPage/demo/chart-area-demo.js"/>"></script>
        <script src="<c:url value="/resources/adminPage/demo/chart-pie-demo.js"/>"></script>
        <script>
            $("a[class='collapse-item active']").attr("href", null);
        </script>
