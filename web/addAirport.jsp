                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="<c:url value="/addAirport"/>">Thêm Sân Bay</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="<c:url value="/admin/allCustomer"/>">Liệt kê khách hàng
                        </div>
                    </div>
                </li>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div id="form_container">
                            <form method="GET" action="addAirportProcess" modelAttribute="airport" id="subscribe_frm">
                                <table>
                                    <tr>
                                        <td>Nhập tên thành phố: </td>
                                        <td>
                                            <input name="cityName"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Nhập tên sân bay: </td>
                                        <td>
                                            <input name="airportName"/>
                                        </td>
                                    </tr>
                                </table>
