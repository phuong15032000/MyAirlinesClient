                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="<c:url value="/addFlight"/>">Thêm Chuyến Bay</a>
                        </div>
                    </div>
                </li>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <form method="GET" action="addFlightProcess" modelAttribute="flight" id="subscribe_frm">
                            <table>
                                <tr>
                                    <td>Chọn máy bay </td>
                                    <td>
                                ...
                                <tr>
                                    <td>Nhập giờ xuất hành: </td>
                                    <td>
                                        <input name="departureTime" type="datetime-local" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>Nhập giờ đến nơi: </td>
                                    <td>
